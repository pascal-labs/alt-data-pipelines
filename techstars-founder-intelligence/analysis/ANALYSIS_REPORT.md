# TechStars Founder Data: Statistical Analysis Report

**Generated:** 2025-10-14 12:39:17

**Dataset Overview:**
- Total Companies Analyzed: 4,042
- Total Founder Records: 7,642
- Austin Founders Identified: 126
- Companies with Austin Founders: 98
...
- **126 founders** currently based in Austin, TX
- **1.84%** of all located TechStars founders
- **2.04x overweight** vs Austin's US population share (0.9%)
...
|------|--------------|------------|
| New York | 418 | 6.09% |
| NO_LOCATION_FOUND | 325 | 4.73% |
| United States | 205 | 2.99% |
| London | 191 | 2.78% |
| San Francisco | 179 | 2.61% |
| Los Angeles | 142 | 2.07% |
| San Francisco Bay Area | 128 | 1.86% |
| Austin | 120 | 1.75% |
| Seattle | 109 | 1.59% |
| Boston | 97 | 1.41% |
...
- **Observed Austin founders:** 126
- **Expected (based on population):** ~61
- **Chi-square statistic:** 66.74
...
**Time Period:** 2012-2024 (13 cohorts)

**Peak Activity:**
- **2019** was the peak year with **33 Austin founders**
- Average per year: **9.7 founders**
- Average YoY growth: **22.1%**
...
- Austin: **41** distinct verticals
- All TechStars: **56** distinct verticals

**Industry Diversity (Herfindahl-Hirschman Index):**
- HHI Score: **677**
- Interpretation: Low concentration (diverse)

**Top 5 Concentration:** 48.4% of founders in top 5 verticals

### Top 10 Industry Verticals (Austin Founders)

| Rank | Vertical | Count | % of Austin |
|------|----------|-------|-------------|
| 1 | Artificial intelligence and machine learning | 44 | 16.0% |
| 2 | Mobile | 36 | 13.1% |
| 3 | Fintech | 27 | 9.8% |
| 4 | Internet of Things | 14 | 5.1% |
| 5 | Insurtech | 12 | 4.4% |
| 6 | Infrastructure | 10 | 3.6% |
| 7 | HRtech | 8 | 2.9% |
| 8 | Supply chain technology | 8 | 2.9% |
| 9 | Lifestyles of Health and Sustainability and wellness | 8 | 2.9% |
| 10 | Cleantech | 8 | 2.9% |
...
|----------|----------|-----------------|------------|
| Artificial intelligence and machine learning | 16.0% | 13.9% | +2.1pp |
| Mobile | 13.1% | 12.5% | +0.6pp |
| Fintech | 9.8% | 9.5% | +0.3pp |
| Internet of Things | 5.1% | 4.6% | +0.5pp |
| Insurtech | 4.4% | 0.0% | +4.4pp |
...
- **Founders per company:** 1.89
- **Overall pipeline efficiency:** 3.12% (companies → Austin founders)
- **Data completeness:** 99.2% of Austin founders have complete data
...
|--------|-------|-----------|-------------|
| Total Pipeline Cost | $70.00 | - | - |
| Cost per Company | $0.0173 | $5.00 | 99.7% savings |
| Cost per Austin Founder | $0.56 | ~$50 | 98.9% savings |

### Throughput Performance

| Pipeline Stage | Throughput (rec/min) | Cost per 1K | Parallelization |
|----------------|---------------------|-------------|-----------------|
| Tavily Discovery | 500 | $0.50 | 20 |
| Bright Data Enrichment | 850 | $12.00 | Async |
| Name Verification | 2,000 | $0.00 | 1 |
| CSV Generation | 1,500 | $0.00 | 1 |


### Performance Highlights

- **Peak throughput:** 2,000 records/min (Name Verification)
- **Bottleneck:** Tavily Discovery (500 records/min)
- **Parallelization speedup:** 20x faster than sequential
- **Total pipeline time:** ~18 minutes for 4,042 companies

### Cost-Benefit Analysis

**Cost per Insight:**
- **$0.56 per high-quality Austin founder lead**
- vs. Traditional recruiting data vendors: ~$50-100 per verified contact
- **Savings: 99.3%** (using $75 midpoint benchmark)

**ROI for Recruiting:**
- If even 1 Austin founder is successfully recruited → ROI > 1000x
- Agency recruiting fee (25% of $120K salary): $30,000
- Pipeline cost: $70.00
- **Savings per hire: $29930.00**
